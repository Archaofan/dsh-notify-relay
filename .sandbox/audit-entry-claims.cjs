 ...
 * checks the claims, against the actual v0.4.3 tarball rather than the working
...
const TARBALL = 'https://github.com/Archaofan/dsh-notify-relay/releases/download/v0.4.3/dsh-notify-relay-0.4.3.tgz'
...
console.log("=== the marketplace entry's claims, against the shipped v0.4.3 ===\n")
