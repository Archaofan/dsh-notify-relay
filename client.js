  ...
  factory: (require) => {
    ...
    const CHANNEL_KINDS = [
      ...
      { id: 'feishu', labelKey: 'chFeishu', fields: [{ key: 'token', labelKey: 'fFeishuToken', secret: true }] },
      {
        ...
        labelKey: 'chDingtalk',
        fields: [
          { key: 'token', labelKey: 'fDingtalkToken', secret: true },
          { key: 'secret', labelKey: 'fDingtalkSecret', secret: true },
        ],
      },
    ...
    const ZH = {
      ...
      fDingtalkToken: 'Access Token',
      fDingtalkSecret: '加签密钥（可空）',
      fNtfyUrl: 'ntfy 地址',
    ...
    const EN = {
      ...
      fDingtalkToken: 'Access token',
      fDingtalkSecret: 'Sign secret (optional)',
      fNtfyUrl: 'ntfy URL',
